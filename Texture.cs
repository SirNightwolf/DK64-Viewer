...
//Edited by Nightwolf Prime using ChatGPT also it's heavily modified so yeah
    ...
    public sealed class Texture : IDisposable
    {
                                           ...
                                           byte[] tlutRgba16=null, bool clampS=false, bool clampT=false)
        {
            ...
            if (rgba.Length != width * height * 4)
                throw new InvalidOperationException("Decoded buffer size mismatch.");

            return FromRGBA8(rgba, width, height, clampS, clampT);
        }

        // ---------- decoders: return BGRA ----------
